...
def get_fashionmnist(image_size=28, test=False, all_train=False):
    ...
    train_dataset = datasets.FashionMNIST(root="f-mnist",
                                          train=True,
                                          download=True,
    ...
    if test:
        test_dataset = datasets.FashionMNIST(root="f-mnist",
                                             train=False,
                                             download=True,
